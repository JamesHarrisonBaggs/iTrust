...
public enum ValidationFormat {
	...
	DATETIME("[\\d]{4}-[\\d]{2}-[\\d]{2}[\\s]{1}[\\d]{2}:[\\d]{2}:[\\d]{2}.[\\d]{1}",
			"mm/dd/yyyy"),
	DELIVERY_TYPE("^(?:vaginal|vacuum|forceps|caesarean|miscarriage)$",
			"must be one of {vaginal, vacuum, forceps, caesarean, miscarriage}"),
	...
	HEAD_CIRCUMFERENCE("[\\d]{0,3}(\\.(\\d){0,1}){0,1}",
