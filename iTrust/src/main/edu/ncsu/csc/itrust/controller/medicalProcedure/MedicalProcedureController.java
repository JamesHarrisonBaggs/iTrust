...
public class MedicalProcedureController extends iTrustController {
	...
	public MedicalProcedureController(DAOFactory factory) throws DBException {
	...
	public List<MedicalProcedure> getMedicalProceduresByOfficeVisit(String officeVisitID) {
		...
		if (officeVisitID != null) {
			...
			try {
				...
				printFacesMessage(FacesMessage.SEVERITY_ERROR, "Unable to Retrieve Medical Procedures",
						"Unable to Retrieve Medical Procedures", null);
			}
		}
