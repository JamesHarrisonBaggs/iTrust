...
CREATE TABLE healthtrackerdata(
	id				BIGINT			UNSIGNED DEFAULT 0,
	data_date		TIMESTAMP		NOT NULL DEFAULT CURRENT_TIMESTAMP,
	calories		INTEGER(15)		UNSIGNED DEFAULT 0,
	steps			INTEGER(15)		UNSIGNED DEFAULT 0,
	distance		FLOAT(19)		UNSIGNED DEFAULT 0,
	floors			INTEGER(15)		UNSIGNED DEFAULT 0,
	mins_sed		INTEGER(15)		UNSIGNED DEFAULT 0,
	mins_light		INTEGER(15)		UNSIGNED DEFAULT 0,
	mins_fair		INTEGER(15)		UNSIGNED DEFAULT 0,
	mins_very		INTEGER(15) 	UNSIGNED DEFAULT 0,
	act_cals 		INTEGER(15) 	UNSIGNED DEFAULT 0,
	act_hours		INTEGER(15) 	UNSIGNED DEFAULT 0,
	hr_low 			INTEGER(15) 	UNSIGNED DEFAULT 0,
	hr_high 		INTEGER(15) 	UNSIGNED DEFAULT 0,
...
CREATE TABLE childbirths(
	...
	visitID			BIGINT(20)		UNSIGNED NOT NULL,
	birthID			INTEGER(15)		UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE childbirth_visits(
	patientID		BIGINT(20)		UNSIGNED DEFAULT 0,
	visitID			BIGINT(20)		UNSIGNED NOT NULL,
	visitDate		DATETIME		NOT NULL,
	preScheduled	BOOLEAN			NOT NULL DEFAULT FALSE,
	deliveryType	VARCHAR(30)		NOT NULL DEFAULT 'vaginal',
...
CREATE TABLE obstetrics_visits(
	id				BIGINT(20)		UNSIGNED NOT NULL,
	visitID			BIGINT(20)		UNSIGNED NOT NULL,
	visitDate		DATETIME		NOT NULL,
	weeksPregnant	INTEGER(15)		UNSIGNED NOT NULL,
	weight			FLOAT(19)		UNSIGNED NOT NULL,
	bloodPressure	VARCHAR(7)		NOT NULL,
	fetalHR			INTEGER(15)		UNSIGNED NOT NULL,
...
CREATE TABLE pregnancies(
	...
	delivery_type	VARCHAR(30)		NOT NULL DEFAULT 'vaginal',
...
CREATE TABLE ultrasounds(
	...
	visitID		BIGINT(20)		UNSIGNED NOT NULL,
	visitDate	DATETIME		NOT NULL,
	fetus		INTEGER(15)		UNSIGNED NOT NULL,
	crl			INTEGER(15)		UNSIGNED NOT NULL,
	bpd			INTEGER(15)		UNSIGNED NOT NULL,
	hc			INTEGER(15)		UNSIGNED NOT NULL,
	fl			INTEGER(15)		UNSIGNED NOT NULL,
	ofd			INTEGER(15)		UNSIGNED NOT NULL,
